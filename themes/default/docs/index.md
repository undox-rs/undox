...
- **Light/Dark Mode** - Automatic theme switching based on system preference, with manual toggle
- **Full-Text Search** - Powered by Pagefind, accessible via `/` keyboard shortcut
